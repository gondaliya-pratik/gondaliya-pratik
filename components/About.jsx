...
const infoData = [
    ...
    },
    {
        ...
        text: 'gondaliyapratik1999@gmail.com',
    },
    {
        icon: <Calendar size={20} />,
        text: 'Born on 30 Dec 1999',
    },
    {
...
const qualificationData = [
    {
        ...
        data: [
            ...
            {
                university: 'Gujarat Technological University',
                qualification: 'Computer Engineering in Diploma',
                years: '2015 - 2018'
            },
        ]
    },
    {
        ...
        data: [
            ...
            {
                company: 'Techtic Technolab Pvt. Ltd.',
                role: 'Software Developer',
                years: '2021 - 2023'
            },
            {
                company: 'Teq Buddies Infosoft Pvt. Ltd.',
...
const skillsData = [
    {
        ...
        data: [
            ...
            {
                name: 'PHP, Node Js, Express Js, Typescript',
            },
            {
                name: 'Sql/MySql, MongoDB',
            },
            {
                name: 'React Js/React Native, Angular, Vue Js, Nest Js',
            },
            {
                name: 'Laravel, CakePHP, Symfony',
            },
            {
                name: 'UI/UX, Figma, Adobe illustrator, Adobe Photoshop, Sketch, Canva',
            },
        ]
    },
    {
                                ...
                                <div className='text-center xl:text-left'>
                                    ...
                                    <div>
                                        {getData(skillsData,'skills').data.map((item,index) => {
                                            const { name } = item;
                                            return (
                                                <div className='w-4/4 text-center xl:text-left mx-auto xl:mx-0' key={index}>
